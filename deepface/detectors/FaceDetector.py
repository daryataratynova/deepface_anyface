...
def detect_face(face_detector, detector_backend, img, align=True, conf_thres = 0.5):

    obj = detect_faces(face_detector, detector_backend, img, align, conf_thres)
...
def detect_faces(face_detector, detector_backend, img, align=True, conf_thres = 0.5):
    ...
    if detect_face_fn:  # pylint: disable=no-else-return
        obj = detect_face_fn(face_detector, img, align , conf_thres)
